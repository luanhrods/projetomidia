...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="py-16 sm:py-20 md:py-24 lg:py-32 bg-card relative overflow-hidden">
      <div className="absolute top-10 sm:top-20 left-0 text-[6rem] sm:text-[10rem] md:text-[14rem] lg:text-[18rem] font-black text-foreground/5 leading-none pointer-events-none select-none whitespace-nowrap">
        SERVICES
      </div>
